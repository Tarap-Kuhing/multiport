...
# // install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/badvpn-udpgw64"
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/banner/bannerssh.conf"
echo "Banner /etc/issue.net" >>/etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

# // Bannerku menu
wget -O /usr/bin/bannerku https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/banner/bannerku && chmod +x /usr/bin/bannerku

# // install bbr
wget https://raw.githubusercontent.com/Tarap-Kuhing/multiport/main/system/bbr.sh && chmod +x bbr.sh && ./bbr.sh
